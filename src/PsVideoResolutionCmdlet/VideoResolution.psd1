#
# Module manifest for module 'VideoResolution'
#
...
@{
    ...
    RootModule           = 'VideoResolution.dll'
    ...
    GUID                 = '7925e8b2-dc54-4346-aab7-cfd5de244fcb'
    ...
    Copyright            = '(c) 2024 Rob Green. All rights reserved.'

    # Description of the functionality provided by this module
    Description          = 'A PowerShell Module to probe video files for their resolution and output results to host and optionally to log files.'
    ...
    CmdletsToExport      = @('Get-VideoResolution')
